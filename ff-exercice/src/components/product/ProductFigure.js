...
export default class ProductFigure extends Component {
	...
	render() {
		...
		let whishlistClass = (this.props.onWhishlist) ? "selected" : "";
		
		return (
			<figure className="product__image-wrapper">
			<ProductImage image={this.props.image} />
			<Button className={`${this.btnConfig.className} ${whishlistClass}`} action={this.props.sendProductToWhishlist}>
				<svg className={`icon ${whishlistClass}`} width="20px" height="20px" viewBox="0 6 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
